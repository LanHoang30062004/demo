...
public class UserServiceImpl implements UserService {
    ...
    public void deleteById(Long id) throws NotFoundException {
        ...
        List<Product> product = new ArrayList<>(user.getProducts()) ;
        List<Auction> auctions = new ArrayList<>(user.getAuctions()) ;
        transactions.forEach(user::removeTransaction);
        product.forEach(user::removeCart);
        auctions.forEach(user::removeAuction);
        this.userRepository.delete(user);
    }

    @Override
    public Boolean existsByProduct(Long productId) throws NotFoundException {
        ...
        return this.userRepository.existsByProducts(product);
    }
